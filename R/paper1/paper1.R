...
for (celltype in unique(sobj1@meta.data$Cell_Type)) {
  tryCatch({
    ...
    perform_DGE_Two_Days(sobj1, celltype, genes=relevant_chromatin_genes, day1='P1', day2='P4')
    perform_DGE_Two_Days(sobj1, celltype, genes=relevant_chromatin_genes, day1='E18', day2='P4')
  }, error = function(e) {
...
cluster_counts <- table(sobj1_celltype@meta.data$Day)


# visualise the variable features being used
celltype = 'Astrocytes'
genes = relevant_chromatin_genes
day1 = 'E18'
day2 = 'P1'
...
DGE_per_day_heatmap = DoHeatmap(sobj_celltype, features = rownames(filtered_chromatin_markers_per_day_significant), group.by = 'Day', size = 3, angle = 90) +
  ggtitle(paste0(celltype, ' DGE ', day1, ' vs ', day2)) +
  theme(plot.title = element_text(hjust = 0.5))  # This centers the title
dittoHeatmap(sobj_celltype, genes=rownames(filtered_chromatin_markers_per_day_significant), annot.by = 'Day', main = 'title',  )
