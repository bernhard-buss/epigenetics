...
celltype_marker_lists <- list(
  ...
  interNeurons = c('Tubb3', 'Dlx2', 'Gad1', 'Sox2', 'Gad2'),
  ependymocytes = c('Hes5', 'Foxj1', 'Sox2', 'Btg2', 'Pax6', 'Tubb3'),
  # cortigo fugal neuron markers
  thalamusProjecting = c('Sox5', 'Bcl11b', 'Tle4', 'Fezf2', "Sox8"),
...
dna_methylation_genes <-
  c("Dnmt1", "Dnmt3a", "Tet1", "Tet2", "Tet3", "Mecp2")
histone_modification_genes <-
  c("Ezh2", "Hdac1", "Hdac2", "Kmt2a", "Suv39H1", "Ash1l", "Setd1a")
chromatin_loop_related_genes <-
  c(
    "Ctcf",
    "Rad21",
    "Smc3",
